...
void main() {
  group('TimeManagementUtil', () {
    ...
    test('getWeekDateRange应返回正确的周一至周日的日期范围', () {
      // 2024年第1周的范围
      final range1 = TimeManagementUtil.getWeekDateRange(
        2024,
        1,
        weekStartDay: WeekStartDay.monday,
      );
      ...
      // 2024年第2周的范围
      final range2 = TimeManagementUtil.getWeekDateRange(
        2024,
        2,
        weekStartDay: WeekStartDay.monday,
      );
    ...
    test('getWeekStartDate应返回正确的周起始日期', () {
      ...
      final start1 = TimeManagementUtil.getWeekStartDate(
        date1,
        weekStartDay: WeekStartDay.monday,
      );
      ...
      final date2 = DateTime(2024, 1, 7);
      final start2 = TimeManagementUtil.getWeekStartDate(
        date2,
        weekStartDay: WeekStartDay.sunday,
      );
      ...
      final date3 = DateTime(2024, 1, 8);
      final start3 = TimeManagementUtil.getWeekStartDate(
        date3,
        weekStartDay: WeekStartDay.sunday,
      );
    ...
    test('getWeekEndDate应返回正确的周结束日期', () {
      ...
      final date1 = DateTime(2024, 1, 1);
      final end1 = TimeManagementUtil.getWeekEndDate(
        date1,
        weekStartDay: WeekStartDay.monday,
      );
      ...
      final date2 = DateTime(2024, 1, 7);
      final end2 = TimeManagementUtil.getWeekEndDate(
        date2,
        weekStartDay: WeekStartDay.sunday,
      );
