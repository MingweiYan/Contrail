...
class JsonEditorPageConstants extends BaseLayoutConstants {
  ...
  // 编辑器内边距
  static final EdgeInsets editorPadding = EdgeInsets.all(
...
class HabitManagementPageConstants extends BaseLayoutConstants {
  ...
  static final EdgeInsets contentPadding = EdgeInsets.only(
...
class AddHabitPageConstants extends BaseLayoutConstants {
  // 头部容器相关参数
  static final EdgeInsets headerPadding = EdgeInsets.all(
    ScreenUtil().setWidth(24),
  );

  // 表单容器相关参数
  static final EdgeInsets formPadding = EdgeInsets.all(
    ScreenUtil().setWidth(24),
  );
  ...
  // 按钮相关参数
  static final EdgeInsets buttonVerticalPadding = EdgeInsets.symmetric(
...
class IconSelectorPageConstants extends BaseLayoutConstants {
  // 页面容器相关参数
  static final EdgeInsets pagePadding = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
...
class HabitTrackingPageConstants extends BaseLayoutConstants {
  ...
  static final double buttonBorderRadius = ScreenUtil().setWidth(12);
  static final EdgeInsets controlButtonPadding = EdgeInsets.all(
    ScreenUtil().setWidth(24),
  );
...
class FullEditorPageConstants extends BaseLayoutConstants {
  // 编辑器相关参数
  static final EdgeInsets editorContainerPadding = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
  static final EdgeInsets editorPadding = EdgeInsets.all(
    ScreenUtil().setWidth(8),
...
class HabitDetailStatisticsPageConstants extends BaseLayoutConstants {
  ...
  static final EdgeInsets moduleContainerPadding = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
  ...
  static final EdgeInsets bodyPadding = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );

  // 图表相关参数
  static final double chartContainerHeight = ScreenUtil().setHeight(300);
  static final EdgeInsets chartContainerPadding = EdgeInsets.only(
    left: ScreenUtil().setWidth(40),
  );
  static final EdgeInsets pieChartPadding = EdgeInsets.only(
...
class ProfilePageConstants extends BaseLayoutConstants {
  ...
  static final double headerBorderRadius = ScreenUtil().setWidth(30);
  static final EdgeInsets contentPadding = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
  ...
  // 间距相关参数
  static final double titleSubtitleSpacing = ScreenUtil().setHeight(8);
  static final EdgeInsets cardMargin = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
  static final double cardBorderRadius = ScreenUtil().setWidth(20);

  // 用户信息卡片相关参数
  static final EdgeInsets userInfoPadding = EdgeInsets.all(
    ScreenUtil().setWidth(24),
  );
  ...
  // 设置卡片相关参数
  static final EdgeInsets settingsContainerMargin = EdgeInsets.all(
    ScreenUtil().setWidth(16),
  );
...
class PomodoroSettingsDialogConstants extends BaseLayoutConstants {
  ...
  static final EdgeInsets dialogPadding = EdgeInsets.all(
    ScreenUtil().setWidth(24),
  );
...
class StatisticsChartWidgetConstants extends BaseLayoutConstants {
  ...
  // 标题相关参数
  static final EdgeInsets titlePadding = EdgeInsets.all(
    ScreenUtil().setWidth(8),
  );
}
...
class StatsShareResultPageConstants extends BaseLayoutConstants {
  ...
  // 图例相关参数
  static final EdgeInsets pieChartLegendPadding = EdgeInsets.symmetric(
    horizontal: ScreenUtil().setWidth(10),
  );
  static final double pieChartLegendHorizontalSpacing = ScreenUtil().setWidth(
    20,
  );
  static final double pieChartLegendVerticalSpacing = ScreenUtil().setHeight(
    12,
  );
