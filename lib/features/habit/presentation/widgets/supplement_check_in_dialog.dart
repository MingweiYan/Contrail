...
/// 补充打卡对话框组件
class SupplementCheckInDialog extends StatelessWidget {
    ...
    return StatefulBuilder(
      builder: (context, setStateDialog) {
        ...
        void handleConfirm() async {
          ...
          try {
            await updateHabitUseCase.execute(selectedHabit!);
            ...
            final statisticsProvider = Provider.of<StatisticsProvider>(parentContext, listen: false);
            ...
            child: SingleChildScrollView(
              ...
              SizedBox(height: SupplementCheckInDialogConstants.titleSpacing),
                ...
                Row(
                  ...
                  SizedBox(height: SupplementCheckInDialogConstants.dateTimeSectionSpacing),
