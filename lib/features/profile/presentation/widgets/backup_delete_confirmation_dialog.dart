  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(BackupDeleteConfirmationDialogConstants.dialogBorderRadius),
      ),
      ...
      actions: [
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(BackupDeleteConfirmationDialogConstants.buttonBorderRadius),
            ),
          ),
          onPressed: onCancel,
        ),
