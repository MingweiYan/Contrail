                      ...
                      children: [
                        ListTile(
                          leading: Container(
                            ...
                            child: Icon(Icons.schedule, color: ThemeHelper.primary(context)),
                          ),
                          title: Text(
                            '自动备份',
                        ...
                        if (backupProvider.autoBackupEnabled) ...[
                          ...
                          ListTile(
                            leading: Container(
                              ...
                              child: Icon(Icons.repeat, color: ThemeHelper.primary(context)),
                            ),
                            title: Text('备份频率:', style: TextStyle(fontSize: DataBackupPageConstants.fontSize_18)),
                        ...
                        if (backupProvider.lastBackupTime != null)
                          Text(
                            '上次备份时间: ' + backupProvider.lastBackupTime!
                                .toIso8601String()
                                .replaceAll('T', ' ')
                                .substring(0, 19),
                            style: TextStyle(color: ThemeHelper.onBackground(context).withValues(alpha: 0.6), fontSize: DataBackupPageConstants.fontSize_16),
                          ),
                        Text(
                          '下次备份: ' +
                              (backupProvider.lastBackupTime != null
                                  ? backupProvider.lastBackupTime!
                                      .add(Duration(days: backupProvider.backupFrequency))
                                      .toIso8601String()
                                      .replaceAll('T', ' ')
                                      .substring(0, 19)
                                  : '开启后立即执行第一次备份'),
                          style: TextStyle(color: ThemeHelper.onBackground(context).withValues(alpha: 0.6), fontSize: ScreenUtil().setSp(16)),
                        ),
                        // 结束：备份设置卡片
                      ],
                    ],
                      ...
                      children: [
                        ListTile(
                          leading: Container(
                            ...
                            child: Icon(Icons.folder_open, color: ThemeHelper.primary(context)),
                          ),
                          title: Text('备份路径', style: TextStyle(fontSize: DataBackupPageConstants.fontSize_18)),
                          subtitle: Text(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                child: Text('默认目录', style: TextStyle(fontSize: DataBackupPageConstants.fontSize_18)),
                              ),
                            ],
                          ),
                        ),
                        ...
                        ListTile(
                          leading: Container(
                            ...
                            child: Icon(Icons.inventory_2, color: ThemeHelper.primary(context)),
                          ),
                          title: Text('本地保留数量', style: TextStyle(fontSize: DataBackupPageConstants.fontSize_18)),
                          trailing: DropdownButton<int>(
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text('执行本地备份', style: TextStyle(fontSize: ScreenUtil().setSp(18))),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(Icons.info_outline, size: ScreenUtil().setSp(16), color: ThemeHelper.onBackground(context).withValues(alpha: 0.7)),
                            SizedBox(width: ScreenUtil().setWidth(6)),
                            Expanded(
                              child: Text(
                                '提示：恢复将用所选备份覆盖当前数据，删除为不可逆操作。',
                                style: TextStyle(fontSize: ScreenUtil().setSp(14), color: ThemeHelper.onBackground(context).withValues(alpha: 0.7)),
                              ),
                            ),
                          ],
                        ),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              '备份时间: ' + backupFile.formattedLastModified + '\n大小: ' + backupFile.formattedSize,
                                    ...
                                    trailing: OutlinedButton.icon(
                                      onPressed: () { _showRestoreConfirmation(backupFile); },
                                      icon: Icon(Icons.restore, size: ScreenUtil().setSp(22)),
                                      label: Text('恢复', style: TextStyle(fontSize: DataBackupPageConstants.fontSize_16, fontWeight: FontWeight.w500)),
                                      style: OutlinedButton.styleFrom(
                                        minimumSize: Size(ScreenUtil().setWidth(100), ScreenUtil().setHeight(34)),
                                        foregroundColor: ThemeHelper.primary(context),
                                        side: BorderSide(color: ThemeHelper.primary(context)),
                                        padding: EdgeInsets.symmetric(horizontal: ScreenUtil().setWidth(10), vertical: ScreenUtil().setHeight(6)),
                                      ),
                                    ),
                                  ),
                                ),
